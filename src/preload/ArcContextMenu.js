...
/** @typedef {import('../app/scripts/arc/AdvancedRestClientApplication').AdvancedRestClientApplication} AdvancedRestClientApplication */
...
export class ArcContextMenu {
  /**
   * @param {AdvancedRestClientApplication} app
   */
  constructor(app) {
    this.app = app;
    this.contextActions = [];
  ...
  /**
   * Dispatches web custom event with type as a combination of `context-action:`
  ...
  /**
   * Dispatches IPC event to the main process with name as a combination of `context-action:`
