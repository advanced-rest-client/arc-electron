...
![Variables list](../.gitbook/assets/image%20%288%29.png)
...
![Empty environment](../.gitbook/assets/image%20%287%29.png)

## Editing variables

To add a new environment first click on "Edit variables" to open variables editor.

![Empty variables editor](../.gitbook/assets/image%20%2827%29.png)
...
![Adding an environment](../.gitbook/assets/image%20%2821%29.png)
...
![Applying variable to a request](../.gitbook/assets/image%20%2823%29.png)

The value is applied to the header just before sending the request

![Sent HTTP message with variable applied to a header](../.gitbook/assets/image%20%2830%29.png)
...
![Composite variables example](../.gitbook/assets/image%20%284%29.png)

As a result the combined value is used with the request.

![Processed variable value](../.gitbook/assets/image%20%2824%29.png)
...
![Variable value editor](../.gitbook/assets/image%20%285%29.png)
...
![Evaluated function](../.gitbook/assets/image%20%2822%29.png)
...
![Grouped generated values](../.gitbook/assets/image%20%2831%29.png)
