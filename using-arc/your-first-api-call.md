...
![Empty request panel](../.gitbook/assets/image%20%2826%29.png)
...
![URL editor with url](../.gitbook/assets/image%20%2820%29.png)
...
![Invalid parameters values](../.gitbook/assets/image%20%2840%29.png)

Don't worry, when the application say that the parameter is invalid you can use "Encode URL" button to fix the problem. 

![Encoded correct values in the URL editor](../.gitbook/assets/image%20%2846%29.png)
...
![Hint message for known header](../.gitbook/assets/image%20%2821%29.png)
...
![Source view in headers editor](../.gitbook/assets/image%20%2834%29.png)
...
![JSON body editor](../.gitbook/assets/image%20%2815%29.png)
...
![x-www-urlencode media type editor](../.gitbook/assets/image%20%2817%29.png)
...
![Multipart data editor](../.gitbook/assets/image%20%2813%29.png)
...
![Response view](../.gitbook/assets/image%20%2822%29.png)
...
![Source view in the response view](../.gitbook/assets/image%20%283%29.png)

JSON response has additional option to render it in table view. It is an alternative way of presenting the data.

![JSON data table](../.gitbook/assets/image%20%2814%29.png)
...
![Response headers](../.gitbook/assets/image%20%2844%29.png)
...
![Timings panel with redirects](../.gitbook/assets/image%20%2839%29.png)
